...
//var key = 'feadfa64f3af22c7f9e02543028dbe93';
// end of atrocity
...
function request(call) {
    ...
    if (call === 'restaurants') {
        var url = 'https://developers.zomato.com/api/v2.1/search?' + search + '&count=' + count + '&lat=' + lat + '&lon=' + lng +
            category + cuisines + '&radius=' + '&sort=' + sortSelection + '&order=' + orderSelection;
    }
...
function setLocationMarker(data) {
    ...
    var marker = new google.maps.Marker({
        ...
        map: map,
        title: "Your Location",
        icon: "https://cdn.glitch.com/c9ec9c87-95da-4e20-9388-d123174f7b33%2Fmarker-icon.png?1555348114955"
    });
...
//returns rupee signs according to the provided input
